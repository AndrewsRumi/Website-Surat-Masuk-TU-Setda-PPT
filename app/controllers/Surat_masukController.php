...
class Surat_masukController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nomor_surat","tanggal_surat","perihal_surat","tanggal_terima","file_surat","diterima_oleh","asal_surat","sifat_surat");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_surat","nomor_surat","tanggal_surat","perihal_surat","tanggal_terima","file_surat","diterima_oleh","asal_surat","sifat_surat");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nomor_surat' => 'required',
